...
'Version 4.09 Working on 06-03-2025 
'Version for testing!
...
Scale_Weight(1) = p.dosp 'p.MAPV 'time zero bottle weight 
Scale_Weight(2) = p.dosp 'p.MAPV 'interval starting bottleweight 
Scale_Weight(3) = p.dosp 'p.MAPV 'current weight feed A
Scale_Weight(4) = p.dosp 'p.MAPV 'glucose interval starting bottleweight
Scale_Weight(5) = p.dosp 'p.MAPV 'current weight glucose
