 <head>
    ...
    <title>Autofeed v4.08form</title>
    <style>
        /* Add some styling for easy readability */
        .form-section {
        ...
        input[type="number"] {
            ...
            padding: 5px;  /* Adjust padding for smaller input size */
        ...
        /* Align the labels and input fields */
        .aligned-labels {
            display: flex;
            align-items: center;
            margin-bottom: 10px;
...
<body>
    ...
    <form id="myForm">
        <div class="aligned-labels">
            <label for="name"><strong>Name:</strong></label>
            <input type="text" id="name" name="name" value="Name..." required>
        </div>

        <div class="aligned-labels">
            <label for="experimentId"><strong>Experiment ID:</strong></label>
            <input type="text" id="experimentId" name="experimentId" value="706R020725..." required>
        </div>

        <div class="aligned-labels">
            <label for="brxId"><strong>BRX ID:</strong></label>
            <input type="text" id="brxId" name="brxId" value="H1-4" required>
        </div><br><br>

         <div class="form-section">
            <h3>Feed Times [hrs]</h3>
            <label for="day1_feedTimes">Day 01:</label>
            <input type="number" id="day1_feedTimes" name="day1_feedTimes"  value="24" required><br>
            <!-- Add similar input fields up to Day 12 for Feed Times -->
            <label for="day2_feedTimes">Day 02:</label>
            <input type="number" id="day2_feedTimes" name="day2_feedTimes" value="48" required><br>
            <label for="day3_feedTimes">Day 03:</label>
            <input type="number" id="day3_feedTimes" name="day3_feedTimes" value="72" required><br>
            
            <label for="day4_feedTimes">Day 04:</label>
            <input type="number" id="day4_feedTimes" name="day4_feedTimes"  value="96" required><br>
            <label for="day5_feedTimes">Day 05:</label>
            <input type="number" id="day5_feedTimes" name="day5_feedTimes"  value="120" required><br>
            <label for="day6_feedTimes">Day 06:</label>
            <input type="number" id="day6_feedTimes" name="day6_feedTimes"  value="144" required><br>
            
            <label for="day7_feedTimes">Day 07:</label>
            <input type="number" id="day7_feedTimes" name="day7_feedTimes"  value="168" required><br>
            <label for="day8_feedTimes">Day 08:</label>
            <input type="number" id="day8_feedTimes" name="day8_feedTimes"  value="192" required><br>
            <label for="day9_feedTimes">Day 09:</label>
            <input type="number" id="day9_feedTimes" name="day9_feedTimes"  value="216" required><br>
            
            <label for="day10_feedTimes">Day 10:</label>
            <input type="number" id="day10_feedTimes" name="day10_feedTimes"  value="240" required><br>
            <label for="day11_feedTimes">Day 11:</label>
            <input type="number" id="day11_feedTimes" name="day11_feedTimes"  value="264" required><br>
            <label for="day12_feedTimes">Day 12:</label>
            <input type="number" id="day12_feedTimes" name="day12_feedTimes"  value="288" required><br><br>
        </div> 

        <div class="form-section">
            <h3>Feed A [g]</h3>
            <label for="day1_feedA">Day 01:</label>
            <input type="number" id="day1_feedA" name="day1_feedA"  value="0" required><br>
            <!-- Add similar input fields up to Day 12 for Feed A -->
            <label for="day2_feedA">Day 02:</label>
            <input type="number" id="day2_feedA" name="day2_feedA" value="45" required><br>
            <label for="day3_feedA">Day 03:</label>
            <input type="number" id="day3_feedA" name="day3_feedA" value="0" required><br>
            
            <label for="day4_feedA">Day 04:</label>
            <input type="number" id="day4_feedA" name="day4_feedA" value="90" required><br>
            <label for="day5_feedA">Day 05:</label>
            <input type="number" id="day5_feedA" name="day5_feedA" value="0" required><br>
            <label for="day6_feedA">Day 06:</label>
            <input type="number" id="day6_feedA" name="day6_feedA" value="120" required><br>
            
            <label for="day7_feedA">Day 07:</label>
            <input type="number" id="day7_feedA" name="day7_feedA" value="0" required><br>
            <label for="day8_feedA">Day 08:</label>
            <input type="number" id="day8_feedA" name="day8_feedA" value="150" required><br>
            <label for="day9_feedA">Day 09:</label>
            <input type="number" id="day9_feedA" name="day9_feedA" value="0" required><br>
            
            <label for="day10_feedA">Day 10:</label>
            <input type="number" id="day10_feedA" name="day10_feedA" value="150" required><br>
            <label for="day11_feedA">Day 11:</label>
            <input type="number" id="day11_feedA" name="day11_feedA" value="0" required><br>
            <label for="day12_feedA">Day 12:</label>
            <input type="number" id="day12_feedA" name="day12_feedA" value="0" required><br><br>
        </div>

        <div class="form-section">
            <h3>Feed B [mL]</h3>
            <label for="day1_feedB">Day 01:</label>
            <input type="number" id="day1_feedB" name="day1_feedB" value="0.0" required><br>
            <!-- Add similar input fields up to Day 12 for Feed B -->
            <label for="day2_feedB">Day 02:</label>
            <input type="number" id="day2_feedB" name="day2_feedB"  value="1.5" required><br>
            <label for="day3_feedB">Day 03:</label>
            <input type="number" id="day3_feedB" name="day3_feedB" value="0.0" required><br>
            
            <label for="day4_feedB">Day 04:</label>
            <input type="number" id="day4_feedB" name="day4_feedB"  value="3.0" required><br>
            <label for="day5_feedB">Day 05:</label>
            <input type="number" id="day5_feedB" name="day5_feedB"  value="0.0" required><br>
            <label for="day6_feedB">Day 06:</label>
            <input type="number" id="day6_feedB" name="day6_feedB"  value="4.5" required><br>
            
            <label for="day7_feedB">Day 07:</label>
            <input type="number" id="day7_feedB" name="day7_feedB"  value="0.0" required><br>
            <label for="day8_feedB">Day 08:</label>
            <input type="number" id="day8_feedB" name="day8_feedB"  value="6.0" required><br>
            <label for="day9_feedB">Day 09:</label>
            <input type="number" id="day9_feedB" name="day9_feedB"  value="0.0" required><br>
            
            <label for="day10_feedB">Day 10:</label>
            <input type="number" id="day10_feedB" name="day10_feedB"  value="7.5" required><br>
            <label for="day11_feedB">Day 11:</label>
            <input type="number" id="day11_feedB" name="day11_feedB"  value="0.0" required><br>
            <label for="day12_feedB">Day 12:</label>
            <input type="number" id="day12_feedB" name="day12_feedB"  value="0.0" required><br><br>
        </div>
		<br><br?
        
        <input type="button" value="Submit" onclick="generateTextFile()">
    </form>

    <script>
        function generateTextFile() {
            var staticText = `'Abbvie | Dynamic time trigger and gravimetric response feed | JDL CL 03-13-2025
...
pumpA_FCal = 105`;
            ...
            var brxId = document.getElementById('brxId').value;
            
            // Create heading text with apostrophes
            var headingText = `'Name: ${name}\n'Experiment ID: ${experimentId}\n'BRX ID: ${brxId}\n`;

            // Gather Feed A data for each day
            var feedAData = "";
            for (var day = 1; day <= 12; day++) {
                var valueA = document.getElementById('day' + day + '_feedA').value;
                feedAData += "Major_Feed_TargetWeight_Value(" + day + ") = " + valueA + "\n";
            }
            
            // Gather Feed B data for each day
            var feedBData = "";
            for (var day = 1; day <= 12; day++) {
                var valueB = document.getElementById('day' + day + '_feedB').value;
                feedBData += "FeedB_VolumeTarget_Value(" + day + ") = " + valueB + "\n";
            }

            // Gather Feed Times data for each day
            var feedTimesData = "";
            for (var day = 1; day <= 12; day++) {
                var valueTime = document.getElementById('day' + day + '_feedTimes').value;
                feedTimesData += "Feed_Time(" + day + ") = " + valueTime + "\n";
            }

                        // Additional script text to append
            var additionalScript = `'Major Feed SetPoint (SP) variables
...
            link.download = experimentId + brxId + '.txt';;
