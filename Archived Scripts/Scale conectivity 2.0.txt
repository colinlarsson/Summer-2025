...
' Check for scale connection before assigning weight values
If Not IsNumeric(p.dosp) OrElse p.dosp <= 0 Then
    .logMessage("██████████████████████████████████████████████████████████████████████████████████████████")
    .logmessage("Scale disconnected. Please check the connection.", MsgBoxStyle.Critical, "Connection Error")
    .logMessage("██████████████████████████████████████████████████████████████████████████████████████████")
    While Not IsNumeric(p.dosp) OrElse p.dosp <= 0
        Threading.Thread.Sleep(1000) ' Wait and check again every second
    End While
    .logMessage("██████████████████████████████████████████████████████████████████████████████████████")
    .logmessage("Scale reconnected. Resuming operation.", MsgBoxStyle.Information, "Connection Restored")
    .logMessage("██████████████████████████████████████████████████████████████████████████████████████")
End If

' Assign scale weights now that connection is confirmed
Scale_Weight(1) = p.dosp ' time zero bottle weight 
Scale_Weight(2) = p.dosp ' interval starting bottleweight 
Scale_Weight(3) = p.dosp ' current weight feed A
Scale_Weight(4) = p.dosp ' glucose interval starting bottleweight
Scale_Weight(5) = p.dosp ' current weight glucose
...
' Check if scale is disconnected before reading weight
If Not IsNumeric(p.dosp) OrElse p.dosp <= 0 Then
    .logMessage("██████████████████████████████████████████████████████████████████████████████████████████")
    .logmessage("Scale disconnected. Please check the connection.", MsgBoxStyle.Critical, "Connection Error")
    .logMessage("██████████████████████████████████████████████████████████████████████████████████████████")
